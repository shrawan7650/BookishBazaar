    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://bookishbazaar-zf22.onrender.com/api/v1/books_detials/${id}`
        );
          ...
          <div className="w-full bg-white md:px-20   md:mt-18 gap-x-40  px-6 flex  flex-col md:flex-row-reverse  ">
            <div className=" order-1 md:order-2 w-full  md:mt-15 mt-12">
              <div className="space-y-6 text-2xl">
                ...
                <p>
                  Category:{deitials.category}
                  <br />
                </p>
                <p>
                  Description:{deitials.description}
                  <br />
                </p>
                <p>price:₹{deitials.price}.</p>
                <p>Year:{deitials.year}</p>
                <p>Quantity:{deitials.quantity}</p>
              </div>
