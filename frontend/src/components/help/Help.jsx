        ...
        <div className="py-7">
          ...
          <div>
            ...
            <div>
              ...
              <div className="mt-8   mb-5 mx-auto max-w-screen-sm lg:max-w-screen-lg flex flex-col lg:flex-row lg:flex-wrap">
                <div className="lg:w-1/2">
                  <div
                    className={` question-and-answer border border-gray-800 select-none cursor-pointer  mx-8 my-3 px-6 py-4 rounded-lg text-sm group`}
                  >
                    <dt className="question">
                      <div className="flex  justify-between">
                        ...
                        <div>
                          <IoIosArrowDropdown
                            className={`text-2xl ${!showHelp1?" rotate-180":""}`}
                  ...
                  >
                    <dt className="question">
                      <div className="flex  justify-between">
                        ...
                        <div>
                          <IoIosArrowDropdown
                            className={`text-2xl ${!showHelp2?" rotate-180":""}`}
                            onClick={() => setShowHelp2(!showHelp2)}
                          />
                        </div>
                      </div>
                    </dt>
                  ...
                  >
                    <dt className="question">
                      <div className="flex  justify-between">
                        ...
                        <div>
                          <IoIosArrowDropdown
                            className={`text-2xl ${!showHelp3?" rotate-180":""}`}
                            onClick={() => setShowHelp3(!showHelp3)}
                          />
                        </div>
                      </div>
                    </dt>
                ...
                <div
                  ...
                  >
                    <dt className="question">
                      <div className="flex  justify-between">
                        <div className="text-indigo-800 font-semibold">
                        Are there more Tailwind book ?
                        </div>
                        <div>
                          <IoIosArrowDropdown
                            className={`text-2xl ${!showHelp4?" rotate-180":""}`}
                            onClick={() => setShowHelp4(!showHelp4)}
                          />
                        </div>
                      </div>
                    </dt>
